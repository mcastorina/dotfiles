" Vim color file -- Miccah
" Maintainer: Miccah
" Last Change: 11-May-2014
...
call s:hi('LineNr', '241', '232', '')
call s:hi('Directory', '39', s:bg, '')
call s:hi('NonText', '240', s:bg, '')
call s:hi('SpecialKey', '240', s:bg, '')
...
call s:hi('Search', '', 173, '')
call s:hi('MatchParen', '', 63, 'bold')
...
call s:hi('Comment', 242, s:bg, '')

call s:hi('Constant', s:purple, s:bg, '')
call s:hi('String', 69, s:bg, '')
call s:hi('Character', s:green, s:bg, '')
call s:hi('Number', s:purple, s:bg, '')
call s:hi('Boolean', s:purple, s:bg, '')
call s:hi('Float', s:purple, s:bg, '')

call s:hi('Identifier', s:white, s:bg, 'bold')
call s:hi('Function', s:white, s:bg, '')
call s:hi('cDefine', s:orange, s:bg, '')
call s:hi('cFunction', s:blue, s:bg, 'bold')

call s:hi('Statement', s:lyellow, s:bg, '')
call s:hi('Conditional', s:yellow, s:bg, '')
call s:hi('Repeat', s:lyellow, s:bg, 'bold')
call s:hi('Label', s:lyellow, s:bg, 'bold')
call s:hi('Operator', s:orange, s:bg, '')
call s:hi('Keyword', s:lyellow, s:bg, '')
call s:hi('Exception', s:orange, s:bg, '')
call s:hi('cComma', s:bwhite, s:bg, '')

call s:hi('PreProc', s:dred, s:bg, '')
call s:hi('Include', s:blue, s:bg, '')
call s:hi('Define', s:red, s:bg, '')
call s:hi('Macro', s:orange, s:bg, '')
call s:hi('Precondit', s:red, s:bg, '')

call s:hi('Type', s:green, s:bg, '')
call s:hi('StorageClass', s:green, s:bg, '')
call s:hi('Structure', s:blue, s:bg, '')
call s:hi('Typedef', s:lgreen, s:bg, '')

call s:hi('Special', s:blue, s:bg, '')
call s:hi('SpecialChar', s:blue, s:bg, '')
call s:hi('Tag', s:blue, s:bg, '')
call s:hi('Delimiter', s:bwhite, s:bg, '')
call s:hi('SpecialComment', s:blue, s:bg, '')
call s:hi('Debug', s:blue, s:bg, '')

call s:hi('Underlined', s:blue, s:bg, 'underline')
call s:hi('Ignore', 238, s:bg, '')
call s:hi('Error', s:white, s:dred, '')
call s:hi('Todo', s:red, s:orange, 'bold')

"call s:hi('Statement', s:green, s:bg, 'bold')
...
"call s:hi('Function', s:white, s:red, 'bold')
"call s:hi('Todo', s:diff, s:bg, 'bold')
"call s:hi('Underlined', s:blue, s:bg, 'underline')
"call s:hi('Ignore', 238, s:bg, '')
"call s:hi('Constant', s:lgreen, s:bg, '')
